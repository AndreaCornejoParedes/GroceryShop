...
public class RestaurantMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(RestaurantMenuActivity.this, "Añada elementos al carrito.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void onAddToCartClick(Menu menu) {
        ...
        buttonCheckout.setText("Checkout (" +totalItemInCart +") ");
    }
    ...
    public void onUpdateCartClick(Menu menu) {
        if(itemsInCartList.contains(menu)) {
            ...
            buttonCheckout.setText("Checkout (" +totalItemInCart +") Pizzas");
        }
    }
